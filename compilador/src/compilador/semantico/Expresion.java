...
public class Expresion {
    ...
    public Expresion(ArrayList <Token> p_TablaLexico,ArrayList <Token> p_TablaSimbolos,int p_Recorrido,String p_Consola,int p_Valor,int p_Tipo){
