...
public class AnalisisLexico {
    ...
    private String m_buscaLexema(String p_Palabra){
        ...
        if(v_Inserta){                                                          // Verifica que el léxema se haya insertado
            ...
            if(v_Indice!=p_Palabra.length()-1){                                 // Analiza que el indice tenga un valor diferente a 0
                a_bdLexico=false;
                if(v_errLexema){                                                    
                    a_consola+="Error [182]: Cadena no completada: '"+p_Palabra.charAt(0)+"'\n";
                    a_consola+="Error en la linea: "+a_Linea+"\n";
                    //p_Palabra=p_Palabra.substring(1,p_Palabra.length());
                }else{
                    a_consola+="Error [180]: No se encuentra simbolo: ' "+p_Palabra.charAt(0)+" ' para cerrar cadena\n";
                    a_consola+="Error en la linea: "+a_Linea+"\n";
                    p_Palabra=p_Palabra.substring(1,p_Palabra.length());
                }
            }else{
